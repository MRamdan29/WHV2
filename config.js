...
global.sig = 'https://instagram.com/ramdan_we'
global.sgh = 'https://github.com/MRamdan29' //github
global.sgc = 'https://chat.whatsapp.com/GSPxsN2Ezma3ucdU9FhblV' //group whatsapp
global.sdc = '-' //discord
global.snh = 'https://youtube.com/channel/UC4YbCp_R58CWslxfyN-jrzA' // my youtube channel
...
/*============== WATERMARK ==============*/
global.wm = '                「 FR-MODS-BOT 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘FR-MODS-BOT ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ FR-MODS-BOT'
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By FR-MODS-DEV`
global.author = '                「 FR-MODS-BOT あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'FR-MODS-BOT'
global.stickauth = `By ©FR-MODS-DEV`
